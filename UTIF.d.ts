...
export interface IFD {
  [property: string]: TiffTag | [number, number][] | Uint8Array;
}
 ...
 * @param LE [optional] If true, should be used with little-endian data. Default is false.
 */
export function encode(ifds: IFD[], LE?: boolean): ArrayBuffer;
